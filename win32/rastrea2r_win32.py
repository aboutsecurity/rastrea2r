...
def yaramem(server,rule,silent):
    ...
    for process in c.win32_Process():
        client_pid=process.ProcessId
        client_pname=process.Name
        client_ppath=process.ExecutablePath
        client_pcmd=process.CommandLine
        client_powner=process.GetOwner()[2]
